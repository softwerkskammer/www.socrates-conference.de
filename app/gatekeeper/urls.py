...
urlpatterns = patterns('',
    ...
    url(r'^login/$', auth_views.login, {'template_name': 'gatekeeper/login.html'}, name='auth_login'),
    url(r'^logout/$', auth_views.logout, {'template_name': 'gatekeeper/logout.html'}, name='auth_logout'),
